                    ...
                    <div class="row">
                        ...
                        <div class="card col-md-6">
                            <div class="card-header m-2">{{ __('Add New Students') }}
                                <a href="{{ route('books.index') }}" class="btn btn-sm btn-danger m-2"
